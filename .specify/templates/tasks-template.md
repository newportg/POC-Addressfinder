...
**Tests**: Include test tasks for every user story. At minimum, add tasks for
behavior validation that fail before implementation and pass after implementation.
...
- [ ] T018 [US1] Add user-facing failure messages and troubleshooting guidance
...
- [ ] T025 [US2] Add structured diagnostics and redaction checks for new flows
...
- [ ] T031 [US3] Document migration/rollback notes if behavior changes
...
- [ ] TXXX Verify observability dashboards/log queries and redaction behavior
